      ...
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
        <div className='flex justify-center items-center'>
          ...
          <form
            ref={form}
            onSubmit={sendEmail}
            className='form p-5 z-30 rounded-2xl bg-black flex flex-col w-full md:w-1/2'
          >
            ...
            <button
              type="submit"
              value="Send"
              className='w-40 text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center justify-center rounded-md hover:scale-110 duration-300'
            >
